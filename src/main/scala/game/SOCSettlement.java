...
import score.Player;
import score.ResourceSet;
import score.ScalaResourceSet;
...
public class SOCSettlement extends SOCPlayingPiece
{
     ...
     * @since 2.0.00
     */
    public static final ResourceSet COST = new ScalaResourceSet(1, 1, 1, 1, 0);
     ...
     */
    public SOCSettlement(CatanPlayer pl, int co, SOCBoard board)
