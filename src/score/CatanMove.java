...
{	
	...
	public boolean Trade (int tradePartner, int cardsRecieved, int cardsTraded)
	{
		if (!diceRolled)
			return false; 
		...
		TurnEvent tradeEvent = new TurnEvent(TurnEventType.TRADE, new int[] {tradePartner, cardsRecieved, cardsTraded}, null);
